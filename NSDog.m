...
{
	if (object == nil || keypath == nil || changeBlock == nil) {
        return nil;
    }
...
#ifdef DISABLE_BARKING_BY_DEFAULT_FOR_THE_DEMO_APP
        _disableBreakpointOnBark      = YES;
        _disableBreakpointOnDealloc   = YES;
#endif
